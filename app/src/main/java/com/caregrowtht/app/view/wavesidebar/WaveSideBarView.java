package com.caregrowtht.app.view.wavesidebar;
...
/**
 * 波浪侧边栏
 * author: haoruigang on 2018-7-30 16:32:52
 */
public class WaveSideBarView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mTextSize = context.getResources().getDimensionPixelSize(R.dimen.text_size_10);
        mLargeTextSize = context.getResources().getDimensionPixelSize(R.dimen.text_size_32);
        mPadding = context.getResources().getDimensionPixelSize(R.dimen.text_size_20);
        if (attrs != null) {
            ...
            mRadius = a.getInt(R.styleable.WaveSideBarView_sidebarRadius, context.getResources().getDimensionPixelSize(R.dimen.text_size_20));
            mBallRadius = a.getInt(R.styleable.WaveSideBarView_sidebarBallRadius, context.getResources().getDimensionPixelSize(R.dimen.text_size_24));
            a.recycle();
        }
