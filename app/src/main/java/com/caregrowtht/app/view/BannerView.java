...
import com.oragee.banners.BannerAdapter;
        ...
        if (viewList != null && viewList.size() != 0) {
            if (mLinearPosition.getChildCount() != viewSize) {
                ...
                for (int i = 0; i < diffCnt; i++) {
                    if (needAdd) {
                        ...
                        img.setBackgroundResource(R.mipmap.gray_dot);
            ...
            for (int i = 0; i < mLinearPosition.getChildCount(); i++) {
                if (i == (curPos % viewSize)) {
                    mLinearPosition.getChildAt(i).setBackgroundResource(R.mipmap.blue_dot);
                } else {
                    mLinearPosition.getChildAt(i).setBackgroundResource(R.mipmap.gray_dot);
                }
            }
        }
    }
