package com.caregrowtht.app.view.picker.view;
...
import com.caregrowtht.app.view.picker.adapter.MinutesWheelAdapter;
...
public class WheelTime {
    ...
    private void setSolar(int year, final int month, int day, int h, int m, int s) {
        ...
        //时
        wv_hours = (WheelView) view.findViewById(R.id.hour);
        wv_hours.setAdapter(new NumericWheelAdapter(6, 22));// 显示时间 6-22 点

        wv_hours.setCurrentItem(h - 6);// 从六点开始
        wv_hours.setGravity(gravity);
        //分
        wv_minutes = (WheelView) view.findViewById(R.id.min);
        wv_minutes.setAdapter(new MinutesWheelAdapter(0, 59));// 分钟以 5 分间隔

        wv_minutes.setCurrentItem(((m % 5) == 0) ? m / 5 : (m / 5 + 1));// 以 5 分钟间隔
        wv_minutes.setGravity(gravity);
        //秒
        wv_seconds = (WheelView) view.findViewById(R.id.second);
        wv_seconds.setAdapter(new NumericWheelAdapter(0, 59));
           ...
           /* int i = wv_month.getCurrentItem() + startMonth;
            ...
            if ((wv_month.getCurrentItem() + startMonth) == startMonth) {
                sb.append((wv_year.getCurrentItem() + startYear)).append("-")
                        ...
                        .append(wv_hours.getCurrentItem() + 6).append(":")// 从六点开始
                        .append(wv_minutes.getCurrentItem() * 5).append(":")// 每5分钟间隔显示
                        .append(wv_seconds.getCurrentItem());
            } else {
                sb.append((wv_year.getCurrentItem() + startYear)).append("-")
                        .append((wv_month.getCurrentItem() + startMonth)).append("-")
                        .append((wv_day.getCurrentItem() + 1)).append(" ")
                        .append(wv_hours.getCurrentItem() + 6).append(":")
