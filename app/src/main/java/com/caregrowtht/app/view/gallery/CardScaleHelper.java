...
public class CardScaleHelper {
        ...
        mRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                if (dx != 0) {//去掉奇怪的内存疯涨问题
                    ...
                    LogUtils.d("CardScaleHelper", String.format("dx=%s, dy=%s, mScrolledX=%s", dx, dy, mCurrentItemOffset));
    ...
    private void computeCurrentItemPos() {
        ...
        LogUtils.d("CardScaleHelper", String.format("=======onCurrentItemPos Changed======= tempPos=%s, mCurrentItemPos=%s", tempPos, mCurrentItemPos));
    }
    ...
    private void onScrolledChangedCallback() {
        ...
        LogUtils.d("CardScaleHelper", String.format("offset=%s, percent=%s", offset, percent));
        View leftView = null;
        View currentView;
        View rightView = null;
